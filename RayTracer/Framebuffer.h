...
public:
	...
	void DrawSimpleBezier(int x1, int y1, int x2, int y2, int steps, const color_t& color);
	void DrawQuadraticBezier(int x1, int y1, int x2, int y2, int x3, int y3, int steps, const color_t& color);
	void DrawCubicBezier(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, int steps, const color_t& color);
